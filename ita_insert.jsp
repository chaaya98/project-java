...
%>
	  ...
	  <form method="POST" action="ita_insertdb.jsp" >
	  <table style="font-family:cursive;color:#666699;">
		...
		<tr>
		<td>DELIVERY DATE<br><br></td><td><input type="text" name="ita_dely_date" placeholder="yyyy-mm-dd"><br><br></td>
		</tr>
		<tr>
		<td>AUCTION STARTING DATE<br><br></td><td><input type="text" name="ita_ra_strt_date" placeholder="yyyy-mm-dd"><br><br></td>
		</tr>
		<tr>
		<td>AUCTION ENDING DATE<br><br></td><td><input type="text" name="ita_ra_end_date" placeholder="yyyy-mm-dd"><br><br></td>
		</tr>
		<tr>
		<td>REMARKS<br><br></td><td><input type="text" name="ita_remarks"><br><br></td>
		</tr>
		</table>
		<input type="submit" value="GENERATE ITA" style="color:#666699;font-family:cursive;">
	  </form>
	</center>
