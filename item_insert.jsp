...
%>
     ...
     <form method="POST" action="item_insertdb.jsp">
	 ...
	 <tr>
	 <td>UNIT<br><br></td><td><input type="text" name="item_unit" required="required"><br><br></td>
	 </tr>
	 <tr>
	 ...
	 <tr>
	 <td>REMARKS<br><br></td><td><textarea  name="item_remarks" rows="2" cols="30" ></textarea><br><br></td>
	 </tr>
	 </table>
	 <input type="submit" value="INSERT ITEMS" style="color:#666699;font-family:cursive;">
     </form>
	</center>
