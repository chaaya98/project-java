...
%>
	  ...
	  <form method="POST" action="ita_deletedb.jsp">
	   <table style="color:#666699;font-family:cursive;">
	  <tr>
	   <td>ITA.NO<br><br></td><td><input type="text" name="dita_no" required="required"><br><br></td>
	  </tr>
	  </table>
      <input type="submit" value="DELETE ITA" style="color:#666699;font-family:cursive;">		  
	  </form>
	  </center>
	   <% } %>
	   </body>
